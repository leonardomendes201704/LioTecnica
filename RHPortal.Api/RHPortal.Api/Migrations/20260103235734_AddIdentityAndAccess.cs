...
{
    /// <inheritdoc />
    public partial class AddIdentityAndAccess : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Route = table.Column<string>(type: "TEXT", maxLength: 240, nullable: false),
                    Icon = table.Column<string>(type: "TEXT", maxLength: 120, nullable: false),
                    Order = table.Column<int>(type: "INTEGER", nullable: false),
                    ParentId = table.Column<Guid>(type: "TEXT", nullable: true),
                    PermissionKey = table.Column<string>(type: "TEXT", maxLength: 160, nullable: false),
